            ...
            <div class="container">
                ...
                <div class=" justify-content-center" id="navbarContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('service2') ? 'active' : '' }}"
                                href="service2">Services</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('riwayat2') ? 'active' : '' }}"
                                href="{{ route('pemesanan.riwayat') }}">Riwayat</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('contacUs2') ? 'active' : '' }}"
                                href="{{ route('pemesanan.create') }}">Contact
                                Us</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('aboutUs2') ? 'active' : '' }}" href="aboutUs2">About
                                Us</a>
                        </li>
                    </ul>
                </div>
